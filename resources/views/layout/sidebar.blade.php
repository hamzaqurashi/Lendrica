<nav class="sidebar">
  <div class="sidebar-header">
    ...
    <img src="{{ asset('/assets/images/logo.png') }}" alt="logo"> <span>LENDRICA</span>
    </a>
  ...
  <div class="sidebar-body">
    <ul class="nav">
      ...
      <li class="nav-item {{ active_class(['users/investors']) }}">
        <a href="{{ url('users/investors') }}" class="nav-link">
          <i class="link-icon" data-feather="users"></i>
          <span class="link-title">Investors</span>
        </a>
      </li>
      <li class="nav-item {{ active_class(['users/borrowers']) }}">
        <a href="{{ url('users/borrowers') }}" class="nav-link">
          <i class="link-icon" data-feather="users"></i>
          <span class="link-title">Borrowers</span>
        </a>
      </li>
      ...
      <li class="nav-item {{ active_class(['#']) }}">
        <a href="{{ url('#') }}" class="nav-link">
          <i class="link-icon" data-feather="users"></i>
          <span class="link-title">Loan Applications</span>
        </a>
      </li>
